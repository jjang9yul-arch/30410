...
st.markdown("""
    ...
    /* Streamlit 기본 상단 공백(padding) 완전히 제거 */
    .block-container {
...
f1_teams_database = [
    ...
    },
    {
        ...
        "drivers": [
            {"name_en": "Valtteri Bottas", "name_kr": "발테리 보타스", "number": "77", "country": "핀란드 핀란드 🇫🇮", "birth": "1989.08.28", "story": "통산 10회 우승을 기록한 메르세데스 전성기의 주역입니다. 풍부한 개발 경험으로 신생 캐딜락 팀의 머신 셋업 기준점을 제시합니다."},
...
# 세션 상태(Session State) 초기화 (선택된 드라이버 기억용)
...
with tab1:
    ...
    # 선택된 드라이버가 존재할 경우 하단에 상세 설명 카드 출력
