...
st.markdown("""
    ...
    .f1-logo-img {
        width: 750px; /* 로고 크기 초대형 확대 */
        max-width: 90%; /* 화면 폭에 맞게 자동 조절 */
        filter: drop-shadow(0px 0px 35px rgba(225, 6, 0, 0.95));
    }
...
# 2026 시즌 22명 전체 드라이버 순위 데이터 (팀명 3자리 대문자 약어)
...
f1_database = [
    {
        ...
        "drivers": [
            {"name_en": "Lando Norris", "name_kr": "랜도 노리스", "number": "1", "country": "영국", "birth": "1999.11.13", "role": "메인 드라이버", "desc": "정교한 퀄리파잉 스피드와 안정적인 레이스 페이스를 겸비한 리딩 드라이버입니다."},
            {"name_en": "Oscar Piastri", "name_kr": "오스카 피아스트리", "number": "81", "country": "호주", "birth": "2001.04.06", "role": "메인 드라이버", "desc": "압박감이 심한 상황에서도 흔들리지 않는 냉정한 레이스 운영이 강점입니다."}
        ]
    },
    {
        ...
        "drivers": [
            {"name_en": "Charles Leclerc", "name_kr": "샤를 르클레르", "number": "16", "country": "모나코", "birth": "1997.10.16", "role": "메인 드라이버", "desc": "단 한 바퀴에 모든 것을 쏟아붓는 폭발적인 원랩 스피드가 최대 무기입니다."},
            {"name_en": "Lewis Hamilton", "name_kr": "루이스 해밀턴", "number": "44", "country": "영국", "birth": "1985.01.07", "role": "메인 드라이버", "desc": "F1 통산 7회 월드 챔피언 기록을 보유한 살아있는 전설입니다."}
        ]
    },
    {
        ...
        "drivers": [
            {"name_en": "George Russell", "name_kr": "조지 러셀", "number": "63", "country": "영국", "birth": "1998.02.15", "role": "메인 드라이버", "desc": "어려운 조건 속에서도 꾸준히 포인트를 획득하는 높은 집중력을 자랑합니다."},
            {"name_en": "Kimi Antonelli", "name_kr": "키미 안토넬리", "number": "12", "country": "이탈리아", "birth": "2006.08.25", "role": "메인 드라이버", "desc": "엄청난 코너링 스피드로 2026 시즌 연승을 이끌고 있는 슈퍼 루키입니다."}
        ]
    },
    {
        ...
        "drivers": [
            {"name_en": "Max Verstappen", "name_kr": "막스 베르스타펜", "number": "33", "country": "네덜란드", "birth": "1997.09.30", "role": "메인 드라이버", "desc": "타협 없는 공격적인 추월 방식과 압도적인 페이스를 보유한 챔피언입니다."},
            {"name_en": "Yuki Tsunoda", "name_kr": "츠노다 유키", "number": "22", "country": "일본", "birth": "2000.05.11", "role": "메인 드라이버", "desc": "과감한 브레이킹 테크닉과 뛰어난 코너 추월 능력이 강점입니다."}
        ]
    },
    {
        ...
        "drivers": [
            {"name_en": "Valtteri Bottas", "name_kr": "발테리 보타스", "number": "77", "country": "핀란드", "birth": "1989.08.28", "role": "메인 드라이버", "desc": "통산 10회 우승 경험을 갖춘 베테랑으로 팀 개발을 이끌고 있습니다."},
            {"name_en": "Sergio Pérez", "name_kr": "세르히오 페레스", "number": "11", "country": "멕시코", "birth": "1990.01.26", "role": "메인 드라이버", "desc": "독보적인 타이어 관리 능력과 탁월한 위기관리 능력을 자랑합니다."}
        ]
    }
]
...
with tab3:
    ...
    st.caption("라운드별 일정과 12R까지의 실제 TOP 3 약어 포디움 결과입니다.")
    st.write("")
